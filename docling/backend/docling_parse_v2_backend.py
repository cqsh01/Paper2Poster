...
try:
    from docling_parse.pdf_parsers import pdf_parser_v2 as pdf_parser_impl
except ImportError:
    from docling_parse.pdf_parsers import pdf_parser as pdf_parser_impl
...
class DoclingParseV2PageBackend(PdfPageBackend):
    def __init__(self, parser: Any, document_hash: str, page_no: int, page_obj: PdfPage):
...
class DoclingParseV2DocumentBackend(PdfDocumentBackend):
    def __init__(self, in_doc: "InputDocument", path_or_stream: Union[BytesIO, Path]):
        ...
        self.parser = pdf_parser_impl("fatal")
